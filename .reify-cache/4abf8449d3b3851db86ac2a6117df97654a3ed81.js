"use strict";module.export({default:()=>VRDisplay});var log;module.link('@luma.gl/core',{log(v){log=v}},0);var Display;module.link('./display',{default(v){Display=v}},1);var createEnterVRButton;module.link('./vr-button',{createEnterVRButton(v){createEnterVRButton=v}},2);/* global window, navigator */




class VRDisplay extends Display {
  static isSupported() {
