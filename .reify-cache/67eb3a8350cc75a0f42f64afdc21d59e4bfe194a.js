"use strict";module.export({GL_PARAMETER_DEFAULTS:()=>GL_PARAMETER_DEFAULTS,GL_PARAMETER_SETTERS:()=>GL_PARAMETER_SETTERS,GL_COMPOSITE_PARAMETER_SETTERS:()=>GL_COMPOSITE_PARAMETER_SETTERS,GL_PARAMETER_GETTERS:()=>GL_PARAMETER_GETTERS},true);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var isWebGL2;module.link('../utils',{isWebGL2(v){isWebGL2=v}},1);// Tables describing WebGL parameters
