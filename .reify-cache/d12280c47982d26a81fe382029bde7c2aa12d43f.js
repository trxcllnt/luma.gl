"use strict";module.export({default:()=>Renderbuffer});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var Resource;module.link('./resource',{default(v){Resource=v}},1);var RENDERBUFFER_FORMATS;module.link('./renderbuffer-formats',{default(v){RENDERBUFFER_FORMATS=v}},2);var isWebGL2;module.link('../webgl-utils',{isWebGL2(v){isWebGL2=v}},3);var assert;module.link('../utils',{assert(v){assert=v}},4);/* eslint-disable no-inline-comments */
