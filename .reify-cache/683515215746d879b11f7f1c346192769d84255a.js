"use strict";module.export({updateForTextures:()=>updateForTextures,getSizeUniforms:()=>getSizeUniforms,getVaryingType:()=>getVaryingType,processAttributeDefinition:()=>processAttributeDefinition});var assert;module.link('../utils',{assert(v){assert=v}},0);var combineInjects,getQualifierDetails,typeToChannelSuffix;module.link('@luma.gl/shadertools',{combineInjects(v){combineInjects=v},getQualifierDetails(v){getQualifierDetails=v},typeToChannelSuffix(v){typeToChannelSuffix=v}},1);
