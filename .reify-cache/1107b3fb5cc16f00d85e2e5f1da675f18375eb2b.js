"use strict";module.export({default:()=>Program});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var Resource;module.link('./resource',{default(v){Resource=v}},1);var Texture;module.link('./texture',{default(v){Texture=v}},2);var Framebuffer;module.link('./framebuffer',{default(v){Framebuffer=v}},3);var parseUniformName,getUniformSetter;module.link('./uniforms',{parseUniformName(v){parseUniformName=v},getUniformSetter(v){getUniformSetter=v}},4);var VertexShader,FragmentShader;module.link('./shader',{VertexShader(v){VertexShader=v},FragmentShader(v){FragmentShader=v}},5);var ProgramConfiguration;module.link('./program-configuration',{default(v){ProgramConfiguration=v}},6);var checkUniformValues,areUniformsEqual,getUniformCopy;module.link('./uniforms',{checkUniformValues(v){checkUniformValues=v},areUniformsEqual(v){areUniformsEqual=v},getUniformCopy(v){getUniformCopy=v}},7);var withParameters;module.link('../context',{withParameters(v){withParameters=v}},8);var assertWebGL2Context,isWebGL2,getKey;module.link('../webgl-utils',{assertWebGL2Context(v){assertWebGL2Context=v},isWebGL2(v){isWebGL2=v},getKey(v){getKey=v}},9);var getPrimitiveDrawMode;module.link('../webgl-utils/attribute-utils',{getPrimitiveDrawMode(v){getPrimitiveDrawMode=v}},10);var log,uid,assert;module.link('../utils',{log(v){log=v},uid(v){uid=v},assert(v){assert=v}},11);
