"use strict";var module1=module;module1.export({default:()=>ShaderModulePass});var Pass;module1.link('./pass',{default(v){Pass=v}},0);var CompositePass;module1.link('./composite-pass',{default(v){CompositePass=v}},1);var ClipSpace;module1.link('../lib/clip-space',{default(v){ClipSpace=v}},2);var normalizeShaderModule;module1.link('@luma.gl/shadertools',{normalizeShaderModule(v){normalizeShaderModule=v}},3);//
