"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var Program,Texture2D;module.link('@luma.gl/webgl',{Program(v){Program=v},Texture2D(v){Texture2D=v}},1);var isBrowser;module.link('@luma.gl/webgl/utils',{isBrowser(v){isBrowser=v}},2);var equals;module.link('math.gl',{equals(v){equals=v}},3);var checkUniformValues,areUniformsEqual,parseUniformName;module.link('@luma.gl/webgl/classes/uniforms',{checkUniformValues(v){checkUniformValues=v},areUniformsEqual(v){areUniformsEqual=v},parseUniformName(v){parseUniformName=v}},4);var fixture;module.link('test/setup',{fixture(v){fixture=v}},5);/* eslint-disable no-inline-comments */
