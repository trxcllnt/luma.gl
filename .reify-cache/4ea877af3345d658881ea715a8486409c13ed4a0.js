"use strict";module.export({default:()=>Buffer});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var Resource;module.link('./resource',{default(v){Resource=v}},1);var Accessor;module.link('./accessor',{default(v){Accessor=v}},2);var assertWebGL2Context,getGLTypeFromTypedArray,getTypedArrayFromGLType;module.link('../webgl-utils',{assertWebGL2Context(v){assertWebGL2Context=v},getGLTypeFromTypedArray(v){getGLTypeFromTypedArray=v},getTypedArrayFromGLType(v){getTypedArrayFromGLType=v}},3);var log,assert,checkProps;module.link('../utils',{log(v){log=v},assert(v){assert=v},checkProps(v){checkProps=v}},4);
