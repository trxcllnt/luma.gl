"use strict";var module1=module;module1.export({default:()=>ShaderModuleRegistry});var ShaderModule;module1.link('./shader-module',{default(v){ShaderModule=v}},0);var assert;module1.link('../utils',{assert(v){assert=v}},1);
