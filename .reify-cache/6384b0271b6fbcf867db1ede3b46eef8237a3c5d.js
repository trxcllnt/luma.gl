"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var Query;module.link('@luma.gl/webgl',{Query(v){Query=v}},1);var util;module.link('util',{default(v){util=v}},2);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},3);var fixture;module.link('test/setup',{fixture(v){fixture=v}},4);/* eslint-disable max-len, max-statements */
