"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},1);var Framebuffer,Renderbuffer,Texture2D,Buffer,getKey;module.link('@luma.gl/webgl',{Framebuffer(v){Framebuffer=v},Renderbuffer(v){Renderbuffer=v},Texture2D(v){Texture2D=v},Buffer(v){Buffer=v},getKey(v){getKey=v}},2);var fixture;module.link('test/setup',{fixture(v){fixture=v}},3);var TEXTURE_FORMATS;module.link('@luma.gl/webgl/classes/texture-formats',{TEXTURE_FORMATS(v){TEXTURE_FORMATS=v}},4);var readPixelsToArray,readPixelsToBuffer,copyToTexture,blit;module.link('@luma.gl/webgl',{readPixelsToArray(v){readPixelsToArray=v},readPixelsToBuffer(v){readPixelsToBuffer=v},copyToTexture(v){copyToTexture=v},blit(v){blit=v}},5);
