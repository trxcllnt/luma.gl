"use strict";module.export({default:()=>DebugContext});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var drawModel;module.link('./draw-model',{default(v){drawModel=v}},1);
