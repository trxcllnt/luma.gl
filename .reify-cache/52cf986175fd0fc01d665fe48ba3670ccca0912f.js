"use strict";module.export({WEBGL2_CONTEXT_POLYFILLS:()=>WEBGL2_CONTEXT_POLYFILLS,WEBGL2_CONTEXT_OVERRIDES:()=>WEBGL2_CONTEXT_OVERRIDES},true);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var assert;module.link('./assert',{default(v){assert=v}},1);var getParameterPolyfill;module.link('./polyfills/get-parameter-polyfill',{getParameterPolyfill(v){getParameterPolyfill=v}},2);
