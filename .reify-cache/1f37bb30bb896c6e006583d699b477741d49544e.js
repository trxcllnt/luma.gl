"use strict";module.export({COLOR_MODE:()=>COLOR_MODE},true);var compileVertexShader,compileFragmentShader;module.link('./compile-shader',{compileVertexShader(v){compileVertexShader=v},compileFragmentShader(v){compileFragmentShader=v}},0);var clamp,lerp;module.link('math.gl',{clamp(v){clamp=v},lerp(v){lerp=v}},1);
...
module.exportDefault(({model, draw, colorMode = COLOR_MODE.NONE}) => {
