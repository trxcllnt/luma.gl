"use strict";var module1=module;module1.export({setDefaultShaderModules:()=>setDefaultShaderModules,registerShaderModules:()=>registerShaderModules,resolveModules:()=>resolveModules,getShaderModule:()=>getShaderModule});module1.export({TEST_EXPORTS:()=>TEST_EXPORTS},true);var ShaderModuleRegistry;module1.link('./shader-module-registry',{default(v){ShaderModuleRegistry=v}},0);
