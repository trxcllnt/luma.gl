"use strict";var module1=module;var createGLContext;module1.link('@luma.gl/core',{createGLContext(v){createGLContext=v}},0);var assembleShaders,picking,fp64;module1.link('@luma.gl/shadertools',{assembleShaders(v){assembleShaders=v},picking(v){picking=v},fp64(v){fp64=v}},1);var test;module1.link('tape-catch',{default(v){test=v}},2);/* eslint-disable camelcase */
