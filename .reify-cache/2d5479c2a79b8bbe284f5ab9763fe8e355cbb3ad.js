"use strict";var formatGLSLError;module.link('@luma.gl/webgl/glsl-utils/format-glsl-error',{default(v){formatGLSLError=v}},0);var test;module.link('tape-catch',{default(v){test=v}},1);
