"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var Texture3D;module.link('@luma.gl/webgl',{Texture3D(v){Texture3D=v}},1);var fixture;module.link('test/setup',{fixture(v){fixture=v}},2);
