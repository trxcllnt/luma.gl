"use strict";module.export({default:()=>ProgramConfiguration});var Accessor;module.link('./accessor',{default(v){Accessor=v}},0);var isWebGL2;module.link('../webgl-utils',{isWebGL2(v){isWebGL2=v}},1);var decomposeCompositeGLType;module.link('../webgl-utils/attribute-utils',{decomposeCompositeGLType(v){decomposeCompositeGLType=v}},2);// Contains metadata describing attribute configurations for a program's shaders
