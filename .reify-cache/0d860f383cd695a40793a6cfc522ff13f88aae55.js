"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},1);var VertexArray,VertexArrayObject,Buffer,Program;module.link('@luma.gl/webgl',{VertexArray(v){VertexArray=v},VertexArrayObject(v){VertexArrayObject=v},Buffer(v){Buffer=v},Program(v){Program=v}},2);var fixture;module.link('test/setup',{fixture(v){fixture=v}},3);
