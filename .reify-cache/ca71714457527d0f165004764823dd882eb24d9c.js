"use strict";module.export({buildHistopyramidBaseLevel:()=>buildHistopyramidBaseLevel,getHistoPyramid:()=>getHistoPyramid,histoPyramidGenerateIndices:()=>histoPyramidGenerateIndices});var Transform,Buffer,copyToTexture,cloneTextureFrom;module.link('@luma.gl/core',{Transform(v){Transform=v},Buffer(v){Buffer=v},copyToTexture(v){copyToTexture=v},cloneTextureFrom(v){cloneTextureFrom=v}},0);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},1);var HISTOPYRAMID_BUILD_VS_UTILS,HISTOPYRAMID_TRAVERSAL_UTILS,HISTOPYRAMID_BASE_BUILD_VS,HISTOPYRAMID_BUILD_VS,HISTOPYRAMID_TRAVERSAL_VS;module.link('./histopyramid-shaders',{HISTOPYRAMID_BUILD_VS_UTILS(v){HISTOPYRAMID_BUILD_VS_UTILS=v},HISTOPYRAMID_TRAVERSAL_UTILS(v){HISTOPYRAMID_TRAVERSAL_UTILS=v},HISTOPYRAMID_BASE_BUILD_VS(v){HISTOPYRAMID_BASE_BUILD_VS=v},HISTOPYRAMID_BUILD_VS(v){HISTOPYRAMID_BUILD_VS=v},HISTOPYRAMID_TRAVERSAL_VS(v){HISTOPYRAMID_TRAVERSAL_VS=v}},2);
