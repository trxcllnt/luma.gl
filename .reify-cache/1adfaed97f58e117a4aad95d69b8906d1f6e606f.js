"use strict";module.export({compileShaderModule:()=>compileShaderModule,compileVertexShader:()=>compileVertexShader,compileFragmentShader:()=>compileFragmentShader});var Compiler;module.link('glsl-transpiler',{default(v){Compiler=v}},0);var getUniformNormalizer;module.link('./normalize-uniforms',{getUniformNormalizer(v){getUniformNormalizer=v}},1);
