"use strict";module.export({encodePickingColor:()=>encodePickingColor,decodePickingColor:()=>decodePickingColor,getNullPickingColor:()=>getNullPickingColor});const NULL_PICKING_COLOR = new Uint8Array([0, 0, 0]);
