"use strict";var module1=module;var test;module1.link('tape-catch',{default(v){test=v}},0);var GL;module1.link('@luma.gl/constants',{default(v){GL=v}},1);var UniformBufferLayout,Buffer,Program;module1.link('@luma.gl/webgl',{UniformBufferLayout(v){UniformBufferLayout=v},Buffer(v){Buffer=v},Program(v){Program=v}},2);var Transform;module1.link('@luma.gl/core',{Transform(v){Transform=v}},3);var fixture;module1.link('test/setup',{fixture(v){fixture=v}},4);
