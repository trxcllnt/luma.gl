"use strict";module.export({getPrimitiveDrawMode:()=>getPrimitiveDrawMode,getPrimitiveCount:()=>getPrimitiveCount,getVertexCount:()=>getVertexCount,decomposeCompositeGLType:()=>decomposeCompositeGLType,getCompositeGLType:()=>getCompositeGLType});var assert;module.link('../utils',{assert(v){assert=v}},0);/* eslint-disable camelcase */
