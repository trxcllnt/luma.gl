"use strict";module.export({default:()=>GLTFAnimator});module.export({ATTRIBUTE_TYPE_TO_COMPONENTS:()=>ATTRIBUTE_TYPE_TO_COMPONENTS,ATTRIBUTE_COMPONENT_TYPE_TO_ARRAY:()=>ATTRIBUTE_COMPONENT_TYPE_TO_ARRAY},true);var Matrix4;module.link('math.gl',{Matrix4(v){Matrix4=v}},0);
