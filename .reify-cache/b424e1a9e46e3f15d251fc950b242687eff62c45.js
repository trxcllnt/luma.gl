"use strict";module.export({FUNCTION_STYLE_SETTINGS_SET1:()=>FUNCTION_STYLE_SETTINGS_SET1},true);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);
...
const FUNCTION_STYLE_SETTINGS_SET1 = {
  blend: true,
