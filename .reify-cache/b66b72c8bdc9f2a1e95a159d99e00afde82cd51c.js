"use strict";module.export({getBuffersFromGeometry:()=>getBuffersFromGeometry,inferAttributeAccessor:()=>inferAttributeAccessor});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var Buffer;module.link('@luma.gl/webgl',{Buffer(v){Buffer=v}},1);var assert;module.link('../utils',{assert(v){assert=v}},2);
