"use strict";module.export({isFormatSupported:()=>isFormatSupported,isLinearFilteringSupported:()=>isLinearFilteringSupported});module.export({TEXTURE_FORMATS:()=>TEXTURE_FORMATS,DATA_FORMAT_CHANNELS:()=>DATA_FORMAT_CHANNELS,TYPE_SIZES:()=>TYPE_SIZES},true);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var isWebGL2;module.link('../webgl-utils',{isWebGL2(v){isWebGL2=v}},1);
