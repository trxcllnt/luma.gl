"use strict";module.export({addModel:()=>addModel,logModel:()=>logModel,removeModel:()=>removeModel,setOverride:()=>setOverride,getOverrides:()=>getOverrides},true);var seer;module.link('seer',{default(v){seer=v}},0);var window;module.link('../utils',{window(v){window=v}},1);
