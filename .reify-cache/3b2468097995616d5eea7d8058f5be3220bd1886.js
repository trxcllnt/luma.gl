"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var getShaderVersion;module.link('@luma.gl/webgl/glsl-utils/get-shader-version',{default(v){getShaderVersion=v}},1);
