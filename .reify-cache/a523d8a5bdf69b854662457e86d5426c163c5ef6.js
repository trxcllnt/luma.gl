"use strict";module.export({default:()=>UniformBufferLayout});var decomposeCompositeGLType;module.link('../webgl-utils/attribute-utils',{decomposeCompositeGLType(v){decomposeCompositeGLType=v}},0);var assert;module.link('../utils',{assert(v){assert=v}},1);/* eslint-disable camelcase */
