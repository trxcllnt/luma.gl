"use strict";module.export({parseUniformName:()=>parseUniformName,getUniformSetter:()=>getUniformSetter,checkUniformValues:()=>checkUniformValues,areUniformsEqual:()=>areUniformsEqual,getUniformCopy:()=>getUniformCopy});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var Framebuffer;module.link('./framebuffer',{default(v){Framebuffer=v}},1);var Renderbuffer;module.link('./renderbuffer',{default(v){Renderbuffer=v}},2);var Texture;module.link('./texture',{default(v){Texture=v}},3);var log;module.link('../utils',{log(v){log=v}},4);
