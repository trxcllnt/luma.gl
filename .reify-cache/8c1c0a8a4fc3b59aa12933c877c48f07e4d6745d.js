"use strict";module.export({default:()=>Query});var Resource;module.link('./resource',{default(v){Resource=v}},0);var FEATURES,hasFeatures;module.link('../features',{FEATURES(v){FEATURES=v},hasFeatures(v){hasFeatures=v}},1);var isWebGL2;module.link('../webgl-utils',{isWebGL2(v){isWebGL2=v}},2);var assert;module.link('../utils',{assert(v){assert=v}},3);// WebGL2 Query (also handles disjoint timer extensions)
