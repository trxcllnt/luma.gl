"use strict";module.export({default:()=>Model});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var Query,TransformFeedback,Buffer;module.link('@luma.gl/webgl',{Query(v){Query=v},TransformFeedback(v){TransformFeedback=v},Buffer(v){Buffer=v}},1);var getBuffersFromGeometry;module.link('./model-utils',{getBuffersFromGeometry(v){getBuffersFromGeometry=v}},2);var BaseModel;module.link('./base-model',{default(v){BaseModel=v}},3);var log,isObjectEmpty,uid,assert;module.link('../utils',{log(v){log=v},isObjectEmpty(v){isObjectEmpty=v},uid(v){uid=v},assert(v){assert=v}},4);
