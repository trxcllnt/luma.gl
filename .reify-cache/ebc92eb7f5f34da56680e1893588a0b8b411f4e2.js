"use strict";module.export({getPageLoadPromise:()=>getPageLoadPromise,createCanvas:()=>createCanvas,getCanvas:()=>getCanvas});var isBrowser;module.link('../utils',{isBrowser(v){isBrowser=v}},0);// Resizing a webgl canvas
