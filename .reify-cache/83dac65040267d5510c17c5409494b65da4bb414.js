"use strict";module.export({default:()=>TextureCube});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var Texture;module.link('./texture',{default(v){Texture=v}},1);var assertWebGLContext;module.link('../webgl-utils',{assertWebGLContext(v){assertWebGLContext=v}},2);var log;module.link('../utils',{log(v){log=v}},3);
