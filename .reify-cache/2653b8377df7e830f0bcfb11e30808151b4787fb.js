"use strict";module.export({default:()=>VertexArray});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var Accessor;module.link('./accessor',{default(v){Accessor=v}},1);var Buffer;module.link('./buffer',{default(v){Buffer=v}},2);var VertexArrayObject;module.link('./vertex-array-object',{default(v){VertexArrayObject=v}},3);var log,assert,stubRemovedMethods;module.link('../utils',{log(v){log=v},assert(v){assert=v},stubRemovedMethods(v){stubRemovedMethods=v}},4);
