"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var ConeGeometry,CubeGeometry,CylinderGeometry,IcoSphereGeometry,PlaneGeometry,SphereGeometry;module.link('@luma.gl/core',{ConeGeometry(v){ConeGeometry=v},CubeGeometry(v){CubeGeometry=v},CylinderGeometry(v){CylinderGeometry=v},IcoSphereGeometry(v){IcoSphereGeometry=v},PlaneGeometry(v){PlaneGeometry=v},SphereGeometry(v){SphereGeometry=v}},1);
