"use strict";module.export({default:()=>GLTFInstantiator});var Matrix4;module.link('math.gl',{Matrix4(v){Matrix4=v}},0);var Buffer,Accessor,GroupNode,log;module.link('@luma.gl/core',{Buffer(v){Buffer=v},_Accessor(v){Accessor=v},GroupNode(v){GroupNode=v},log(v){log=v}},1);var GLTFAnimator;module.link('./gltf-animator',{default(v){GLTFAnimator=v}},2);var createGLTFModel;module.link('./create-gltf-model',{default(v){createGLTFModel=v}},3);
