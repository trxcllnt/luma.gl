"use strict";module.export({default:()=>Resource});var lumaStats;module.link('../init',{lumaStats(v){lumaStats=v}},0);var assertWebGLContext,isWebGL2,getKey,getKeyValue;module.link('../webgl-utils',{assertWebGLContext(v){assertWebGLContext=v},isWebGL2(v){isWebGL2=v},getKey(v){getKey=v},getKeyValue(v){getKeyValue=v}},1);var uid,assert,stubRemovedMethods;module.link('../utils',{uid(v){uid=v},assert(v){assert=v},stubRemovedMethods(v){stubRemovedMethods=v}},2);
