"use strict";var module1=module;var GL;module1.link('@luma.gl/constants',{default(v){GL=v}},0);var TransformFeedback,Buffer;module1.link('@luma.gl/webgl',{TransformFeedback(v){TransformFeedback=v},Buffer(v){Buffer=v}},1);var Model;module1.link('@luma.gl/core',{Model(v){Model=v}},2);var test;module1.link('tape-catch',{default(v){test=v}},3);var fixture;module1.link('test/setup',{fixture(v){fixture=v}},4);
