"use strict";module.export({getDebugTableForVertexArray:()=>getDebugTableForVertexArray});var Buffer;module.link('../classes/buffer',{default(v){Buffer=v}},0);var getKey;module.link('../webgl-utils',{getKey(v){getKey=v}},1);var getCompositeGLType;module.link('../webgl-utils/attribute-utils',{getCompositeGLType(v){getCompositeGLType=v}},2);var formatValue;module.link('../utils',{formatValue(v){formatValue=v}},3);
