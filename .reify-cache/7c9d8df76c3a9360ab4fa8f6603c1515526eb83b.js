"use strict";var module1=module;module1.export({default:()=>ShaderModule});var transpileShader;module1.link('./transpile-shader',{default(v){transpileShader=v}},0);var assert;module1.link('../utils',{assert(v){assert=v}},1);
