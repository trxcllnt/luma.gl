"use strict";module.export({default:()=>ShaderCache});var VertexShader,FragmentShader,Program;module.link('@luma.gl/webgl',{VertexShader(v){VertexShader=v},FragmentShader(v){FragmentShader=v},Program(v){Program=v}},0);var assert;module.link('../utils',{assert(v){assert=v}},1);
