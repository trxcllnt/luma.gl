"use strict";module.export({getPlatformShaderDefines:()=>getPlatformShaderDefines,getVersionDefines:()=>getVersionDefines});var getContextInfo,hasFeatures,canCompileGLGSExtension,FEATURES;module.link('../utils/webgl-info',{getContextInfo(v){getContextInfo=v},hasFeatures(v){hasFeatures=v},canCompileGLGSExtension(v){canCompileGLGSExtension=v},FEATURES(v){FEATURES=v}},0);
