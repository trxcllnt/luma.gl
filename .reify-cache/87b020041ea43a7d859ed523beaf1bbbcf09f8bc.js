"use strict";module.export({default:()=>GLTFEnvironment});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var Texture2D,TextureCube,loadImage;module.link('@luma.gl/core',{Texture2D(v){Texture2D=v},TextureCube(v){TextureCube=v},loadImage(v){loadImage=v}},1);
