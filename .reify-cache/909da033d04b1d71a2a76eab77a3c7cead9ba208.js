"use strict";module.export({default:()=>Framebuffer});module.export({FRAMEBUFFER_ATTACHMENT_PARAMETERS:()=>FRAMEBUFFER_ATTACHMENT_PARAMETERS},true);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var Resource;module.link('./resource',{default(v){Resource=v}},1);var Texture2D;module.link('./texture-2d',{default(v){Texture2D=v}},2);var Renderbuffer;module.link('./renderbuffer',{default(v){Renderbuffer=v}},3);var clear,clearBuffer;module.link('./clear',{clear(v){clear=v},clearBuffer(v){clearBuffer=v}},4);var copyToDataUrl;module.link('./copy-and-blit.js',{copyToDataUrl(v){copyToDataUrl=v}},5);var getFeatures;module.link('../features',{getFeatures(v){getFeatures=v}},6);var isWebGL2,assertWebGL2Context,getKey;module.link('../webgl-utils',{isWebGL2(v){isWebGL2=v},assertWebGL2Context(v){assertWebGL2Context=v},getKey(v){getKey=v}},7);var log,assert;module.link('../utils',{log(v){log=v},assert(v){assert=v}},8);
