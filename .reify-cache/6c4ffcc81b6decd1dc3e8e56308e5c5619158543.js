"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},1);var Buffer,Texture2D,getKey,isWebGL2,readPixelsToArray;module.link('@luma.gl/webgl',{Buffer(v){Buffer=v},Texture2D(v){Texture2D=v},getKey(v){getKey=v},isWebGL2(v){isWebGL2=v},readPixelsToArray(v){readPixelsToArray=v}},2);var TEXTURE_FORMATS;module.link('@luma.gl/webgl/classes/texture-formats',{TEXTURE_FORMATS(v){TEXTURE_FORMATS=v}},3);var testSamplerParameters,SAMPLER_PARAMETERS,SAMPLER_PARAMETERS_WEBGL2;module.link('./sampler.utils',{testSamplerParameters(v){testSamplerParameters=v},SAMPLER_PARAMETERS(v){SAMPLER_PARAMETERS=v},SAMPLER_PARAMETERS_WEBGL2(v){SAMPLER_PARAMETERS_WEBGL2=v}},4);var fixture;module.link('test/setup',{fixture(v){fixture=v}},5);/* global document */
