"use strict";var Buffer,Transform,Texture2D;module.link('@luma.gl/core',{Buffer(v){Buffer=v},Transform(v){Transform=v},Texture2D(v){Texture2D=v}},0);var test;module.link('tape-catch',{default(v){test=v}},1);var fixture;module.link('test/setup',{fixture(v){fixture=v}},2);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},3);
