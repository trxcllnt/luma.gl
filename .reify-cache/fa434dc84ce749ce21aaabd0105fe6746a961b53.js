"use strict";module.export({default:()=>Texture});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var Resource;module.link('./resource',{default(v){Resource=v}},1);var Buffer;module.link('./buffer',{default(v){Buffer=v}},2);var TEXTURE_FORMATS,DATA_FORMAT_CHANNELS,TYPE_SIZES,isFormatSupported,isLinearFilteringSupported;module.link('./texture-formats',{TEXTURE_FORMATS(v){TEXTURE_FORMATS=v},DATA_FORMAT_CHANNELS(v){DATA_FORMAT_CHANNELS=v},TYPE_SIZES(v){TYPE_SIZES=v},isFormatSupported(v){isFormatSupported=v},isLinearFilteringSupported(v){isLinearFilteringSupported=v}},3);var withParameters;module.link('../context',{withParameters(v){withParameters=v}},4);var isWebGL2,assertWebGL2Context,WebGLBuffer;module.link('../webgl-utils',{isWebGL2(v){isWebGL2=v},assertWebGL2Context(v){assertWebGL2Context=v},WebGLBuffer(v){WebGLBuffer=v}},5);var log,uid,isPowerOfTwo,assert;module.link('../utils',{log(v){log=v},uid(v){uid=v},isPowerOfTwo(v){isPowerOfTwo=v},assert(v){assert=v}},6);
