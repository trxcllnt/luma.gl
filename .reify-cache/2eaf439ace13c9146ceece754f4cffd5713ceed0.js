"use strict";var getQualifierDetails,getPassthroughFS,typeToChannelSuffix,typeToChannelCount,convertToVec4;module.link('@luma.gl/shadertools/utils/shader-utils',{getQualifierDetails(v){getQualifierDetails=v},getPassthroughFS(v){getPassthroughFS=v},typeToChannelSuffix(v){typeToChannelSuffix=v},typeToChannelCount(v){typeToChannelCount=v},convertToVec4(v){convertToVec4=v}},0);var test;module.link('tape-catch',{default(v){test=v}},1);
