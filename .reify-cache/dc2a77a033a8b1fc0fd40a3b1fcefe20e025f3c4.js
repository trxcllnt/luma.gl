"use strict";module.export({default:()=>polyfillContext});var assert;module.link('./assert',{default(v){assert=v}},0);var WEBGL2_CONTEXT_POLYFILLS,WEBGL2_CONTEXT_OVERRIDES;module.link('./polyfill-table',{WEBGL2_CONTEXT_POLYFILLS(v){WEBGL2_CONTEXT_POLYFILLS=v},WEBGL2_CONTEXT_OVERRIDES(v){WEBGL2_CONTEXT_OVERRIDES=v}},1);// WebGL1/WebGL2 extension polyfill support
//
