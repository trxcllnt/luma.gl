"use strict";module.export({getParameterPolyfill:()=>getParameterPolyfill});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);/* eslint-disable no-inline-comments, max-len, camelcase */
