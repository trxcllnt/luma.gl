"use strict";module.export({default:()=>Pass});var Framebuffer,withParameters;module.link('@luma.gl/webgl',{Framebuffer(v){Framebuffer=v},withParameters(v){withParameters=v}},0);//
// A base render pass.
//
