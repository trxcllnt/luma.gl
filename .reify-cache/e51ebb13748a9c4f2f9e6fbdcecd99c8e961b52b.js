"use strict";var transpileShader;module.link('@luma.gl/shadertools/lib/transpile-shader',{default(v){transpileShader=v}},0);var test;module.link('tape-catch',{default(v){test=v}},1);/* eslint-disable camelcase */
