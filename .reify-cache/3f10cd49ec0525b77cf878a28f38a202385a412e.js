"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},1);var VertexArrayObject;module.link('@luma.gl/webgl',{VertexArrayObject(v){VertexArrayObject=v}},2);var fixture;module.link('test/setup',{fixture(v){fixture=v}},3);
