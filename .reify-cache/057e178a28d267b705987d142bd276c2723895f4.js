"use strict";module.export({default:()=>VertexArrayObject});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var Resource;module.link('./resource',{default(v){Resource=v}},1);var Buffer;module.link('./buffer',{default(v){Buffer=v}},2);var isWebGL2;module.link('../webgl-utils',{isWebGL2(v){isWebGL2=v}},3);var getScratchArray,fillArray;module.link('../utils/array-utils-flat',{getScratchArray(v){getScratchArray=v},fillArray(v){fillArray=v}},4);var assert;module.link('../utils',{assert(v){assert=v}},5);var getBrowser;module.link('probe.gl',{getBrowser(v){getBrowser=v}},6);
