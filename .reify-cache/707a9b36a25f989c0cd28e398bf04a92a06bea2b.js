"use strict";var getKey,getContextInfo;module.link('@luma.gl/webgl',{getKey(v){getKey=v},getContextInfo(v){getContextInfo=v}},0);var WEBGL_LIMITS;module.link('@luma.gl/webgl/features/webgl-limits-table',{default(v){WEBGL_LIMITS=v}},1);var test;module.link('tape-catch',{default(v){test=v}},2);var fixture;module.link('test/setup',{fixture(v){fixture=v}},3);
