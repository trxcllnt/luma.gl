"use strict";module.export({readPixelsToArray:()=>readPixelsToArray,readPixelsToBuffer:()=>readPixelsToBuffer,copyToDataUrl:()=>copyToDataUrl,copyToImage:()=>copyToImage,copyToTexture:()=>copyToTexture,blit:()=>blit});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var Buffer;module.link('./buffer',{default(v){Buffer=v}},1);var Framebuffer;module.link('./framebuffer',{default(v){Framebuffer=v}},2);var Texture;module.link('./texture',{default(v){Texture=v}},3);var withParameters;module.link('../context',{withParameters(v){withParameters=v}},4);var assertWebGL2Context,flipRows,scalePixels;module.link('../webgl-utils',{assertWebGL2Context(v){assertWebGL2Context=v},flipRows(v){flipRows=v},scalePixels(v){scalePixels=v}},5);var getTypedArrayFromGLType,getGLTypeFromTypedArray;module.link('../webgl-utils/typed-array-utils',{getTypedArrayFromGLType(v){getTypedArrayFromGLType=v},getGLTypeFromTypedArray(v){getGLTypeFromTypedArray=v}},6);var glFormatToComponents,glTypeToBytes;module.link('../webgl-utils/format-utils',{glFormatToComponents(v){glFormatToComponents=v},glTypeToBytes(v){glTypeToBytes=v}},7);var toFramebuffer;module.link('../webgl-utils/texture-utils',{toFramebuffer(v){toFramebuffer=v}},8);var assert,log;module.link('../utils',{assert(v){assert=v},log(v){log=v}},9);
