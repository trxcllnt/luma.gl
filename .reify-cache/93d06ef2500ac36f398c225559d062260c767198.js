"use strict";module.export({default:()=>formatGLSLCompilerError,parseGLSLCompilerError:()=>parseGLSLCompilerError});var getShaderName;module.link('./get-shader-name',{default(v){getShaderName=v}},0);var getShaderTypeName;module.link('./get-shader-type-name',{default(v){getShaderTypeName=v}},1);// TODO - formatGLSLCompilerError should not depend on this
