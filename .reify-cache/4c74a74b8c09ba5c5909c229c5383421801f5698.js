"use strict";var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var Buffer,isWebGL;module.link('@luma.gl/webgl',{Buffer(v){Buffer=v},isWebGL(v){isWebGL=v}},1);var test;module.link('tape-catch',{default(v){test=v}},2);var fixture;module.link('test/setup',{fixture(v){fixture=v}},3);
