"use strict";module.export({default:()=>TransformFeedback});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var Resource;module.link('./resource',{default(v){Resource=v}},1);var Buffer;module.link('./buffer',{default(v){Buffer=v}},2);var isWebGL2,assertWebGL2Context;module.link('../webgl-utils',{isWebGL2(v){isWebGL2=v},assertWebGL2Context(v){assertWebGL2Context=v}},3);var log,isObjectEmpty;module.link('../utils',{log(v){log=v},isObjectEmpty(v){isObjectEmpty=v}},4);
