"use strict";module.export({ENUM_STYLE_SETTINGS_SET1_PRIMITIVE:()=>ENUM_STYLE_SETTINGS_SET1_PRIMITIVE,ENUM_STYLE_SETTINGS_SET1:()=>ENUM_STYLE_SETTINGS_SET1,ENUM_STYLE_SETTINGS_SET2:()=>ENUM_STYLE_SETTINGS_SET2},true);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);

// eslint-disable-next-line
// NOTE: These settings should be in sync with FUNCTION_STYLE_SETTINGS_SET1
const ENUM_STYLE_SETTINGS_SET1_PRIMITIVE = {
  [GL.BLEND]: true,
...
const ENUM_STYLE_SETTINGS_SET1 = Object.assign({}, ENUM_STYLE_SETTINGS_SET1_PRIMITIVE, {
...
// eslint-disable-next-line
const ENUM_STYLE_SETTINGS_SET2 = {
  [GL.BLEND]: true,
