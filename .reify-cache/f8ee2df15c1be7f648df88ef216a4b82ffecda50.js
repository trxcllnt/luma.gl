"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},1);var Framebuffer,Renderbuffer,Texture2D;module.link('@luma.gl/webgl',{Framebuffer(v){Framebuffer=v},Renderbuffer(v){Renderbuffer=v},Texture2D(v){Texture2D=v}},2);var fixture;module.link('test/setup',{fixture(v){fixture=v}},3);/* eslint-disable max-len */
