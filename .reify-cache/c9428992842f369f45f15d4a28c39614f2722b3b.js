"use strict";var module1=module;module1.export({setParameter:()=>setParameter,setParameters:()=>setParameters,getParameter:()=>getParameter,getParameters:()=>getParameters,getDefaultParameters:()=>getDefaultParameters,resetParameters:()=>resetParameters,getModifiedParameters:()=>getModifiedParameters});var GL_PARAMETER_DEFAULTS,GL_PARAMETER_SETTERS,GL_COMPOSITE_PARAMETER_SETTERS,GL_PARAMETER_GETTERS;module1.link('./webgl-parameter-tables',{GL_PARAMETER_DEFAULTS(v){GL_PARAMETER_DEFAULTS=v},GL_PARAMETER_SETTERS(v){GL_PARAMETER_SETTERS=v},GL_COMPOSITE_PARAMETER_SETTERS(v){GL_COMPOSITE_PARAMETER_SETTERS=v},GL_PARAMETER_GETTERS(v){GL_PARAMETER_GETTERS=v}},0);var deepArrayEqual;module1.link('../utils/deep-array-equal',{default(v){deepArrayEqual=v}},1);var assert;module1.link('../utils',{assert(v){assert=v}},2);// Provides a unified API for getting and setting any WebGL parameter
