"use strict";var VertexShader,FragmentShader,Program,ShaderCache;module.link('@luma.gl/core',{VertexShader(v){VertexShader=v},FragmentShader(v){FragmentShader=v},Program(v){Program=v},_ShaderCache(v){ShaderCache=v}},0);var test;module.link('tape-catch',{default(v){test=v}},1);var fixture;module.link('test/setup',{fixture(v){fixture=v}},2);
