"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var Program,Buffer,VertexArray;module.link('@luma.gl/webgl',{Program(v){Program=v},Buffer(v){Buffer=v},VertexArray(v){VertexArray=v}},1);var fixture;module.link('test/setup',{fixture(v){fixture=v}},2);
