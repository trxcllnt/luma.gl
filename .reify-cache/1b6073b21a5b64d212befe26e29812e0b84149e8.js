"use strict";module.export({default:()=>SphereGeometry});var Geometry;module.link('../geometry/geometry',{default(v){Geometry=v}},0);var uid;module.link('../utils',{uid(v){uid=v}},1);
