"use strict";var assert;module.link('@luma.gl/core',{assert(v){assert=v}},0);var GLTFLoader;module.link('@loaders.gl/gltf',{GLTFLoader(v){GLTFLoader=v}},1);var createGLTFObjects;module.link('./create-gltf-objects',{default(v){createGLTFObjects=v}},2);/* global window */
