"use strict";var canCompileGLGSExtension,hasFeature,hasFeatures,getFeatures,FEATURES;module.link('@luma.gl/webgl',{canCompileGLGSExtension(v){canCompileGLGSExtension=v},hasFeature(v){hasFeature=v},hasFeatures(v){hasFeatures=v},getFeatures(v){getFeatures=v},FEATURES(v){FEATURES=v}},0);var test;module.link('tape-catch',{default(v){test=v}},1);var makeSpy;module.link('@probe.gl/test-utils',{makeSpy(v){makeSpy=v}},2);var fixture;module.link('test/setup',{fixture(v){fixture=v}},3);
