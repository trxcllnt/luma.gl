"use strict";var getParameterPolyfill;module.link('@luma.gl/webgl2-polyfill/polyfills/get-parameter-polyfill',{getParameterPolyfill(v){getParameterPolyfill=v}},0);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},1);var test;module.link('tape-catch',{default(v){test=v}},2);var fixture;module.link('test/setup',{fixture(v){fixture=v}},3);
