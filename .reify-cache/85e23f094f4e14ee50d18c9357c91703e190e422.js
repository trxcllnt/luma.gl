"use strict";module.export({default:()=>trackContextState,pushContextState:()=>pushContextState,popContextState:()=>popContextState});module.export({clone:()=>clone,deepEqual:()=>deepEqual},true);var GL_STATE_SETTERS;module.link('./webgl-function-to-parameters-table',{default(v){GL_STATE_SETTERS=v}},0);var GL_PARAMETER_DEFAULTS;module.link('../unified-parameter-api/webgl-parameter-tables',{GL_PARAMETER_DEFAULTS(v){GL_PARAMETER_DEFAULTS=v}},1);var setParameters,getParameters;module.link('../unified-parameter-api/unified-parameter-api',{setParameters(v){setParameters=v},getParameters(v){getParameters=v}},2);var assert;module.link('../utils',{assert(v){assert=v}},3);// Support for listening to context state changes and intercepting state queries
//
