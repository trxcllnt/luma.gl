"use strict";var test;module.link('tape-catch',{default(v){test=v}},0);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},1);var getParameter,getParameters,setParameters,resetParameters,withParameters;module.link('@luma.gl/webgl-state-tracker',{getParameter(v){getParameter=v},getParameters(v){getParameters=v},setParameters(v){setParameters=v},resetParameters(v){resetParameters=v},withParameters(v){withParameters=v}},2);var Framebuffer,getKey;module.link('@luma.gl/core',{Framebuffer(v){Framebuffer=v},getKey(v){getKey=v}},3);var GL_PARAMETERS;module.link('@luma.gl/webgl-state-tracker/unified-parameter-api/webgl-parameter-tables',{GL_PARAMETER_DEFAULTS(v){GL_PARAMETERS=v}},4);var ENUM_STYLE_SETTINGS_SET1;module.link('../data/sample-enum-settings',{ENUM_STYLE_SETTINGS_SET1(v){ENUM_STYLE_SETTINGS_SET1=v}},5);var FUNCTION_STYLE_SETTINGS_SET1;module.link('../data/sample-function-settings',{FUNCTION_STYLE_SETTINGS_SET1(v){FUNCTION_STYLE_SETTINGS_SET1=v}},6);var createTestContext;module.link('test/setup',{createTestContext(v){createTestContext=v}},7);
