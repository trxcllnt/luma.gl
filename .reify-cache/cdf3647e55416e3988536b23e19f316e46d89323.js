"use strict";module.export({FEATURES:()=>FEATURES,getContextInfo:()=>getContextInfo,canCompileGLGSExtension:()=>canCompileGLGSExtension,hasFeatures:()=>hasFeatures});var isOldIE;module.link('./is-old-ie',{default(v){isOldIE=v}},0);var assert;module.link('./assert',{default(v){assert=v}},1);// Feature detection for WebGL
//
