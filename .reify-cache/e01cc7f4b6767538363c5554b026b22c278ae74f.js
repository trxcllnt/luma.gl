"use strict";var module1=module;module1.export({default:()=>BaseModel});var GL;module1.link('@luma.gl/constants',{default(v){GL=v}},0);var isWebGL,Query,Program,VertexArray,clear;module1.link('@luma.gl/webgl',{isWebGL(v){isWebGL=v},Query(v){Query=v},Program(v){Program=v},VertexArray(v){VertexArray=v},clear(v){clear=v}},1);var MODULAR_SHADERS,assembleShaders;module1.link('@luma.gl/shadertools',{MODULAR_SHADERS(v){MODULAR_SHADERS=v},assembleShaders(v){assembleShaders=v}},2);var getDebugTableForUniforms,getDebugTableForVertexArray,getDebugTableForProgramConfiguration;module1.link('@luma.gl/webgl',{getDebugTableForUniforms(v){getDebugTableForUniforms=v},getDebugTableForVertexArray(v){getDebugTableForVertexArray=v},getDebugTableForProgramConfiguration(v){getDebugTableForProgramConfiguration=v}},3);var addModel,removeModel,logModel,getOverrides;module1.link('../debug/seer-integration',{addModel(v){addModel=v},removeModel(v){removeModel=v},logModel(v){logModel=v},getOverrides(v){getOverrides=v}},4);var log,isObjectEmpty,uid,assert;module1.link('../utils',{log(v){log=v},isObjectEmpty(v){isObjectEmpty=v},uid(v){uid=v},assert(v){assert=v}},5);// Shared code between Model and MeshModel
