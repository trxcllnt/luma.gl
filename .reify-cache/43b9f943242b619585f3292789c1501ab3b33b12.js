"use strict";module.export({testSamplerParameters:()=>testSamplerParameters});module.export({SAMPLER_PARAMETERS:()=>SAMPLER_PARAMETERS,SAMPLER_PARAMETERS_WEBGL2:()=>SAMPLER_PARAMETERS_WEBGL2},true);var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var getKey;module.link('@luma.gl/webgl',{getKey(v){getKey=v}},1);/* eslint-disable max-len */
...
const SAMPLER_PARAMETERS_WEBGL2 = {
  [GL.TEXTURE_WRAP_R]: {
    [GL.REPEAT]: 'use fractional part of texture coordinates',
    [GL.CLAMP_TO_EDGE]: 'clamp texture coordinates',
    [GL.MIRRORED_REPEAT]:
...
function testSamplerParameters({t, texture, parameters}) {
