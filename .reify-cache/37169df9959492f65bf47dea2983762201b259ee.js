"use strict";module.export({default:()=>AnimationLoopProxy});var getPageLoadPromise,getCanvas;module.link('@luma.gl/webgl',{getPageLoadPromise(v){getPageLoadPromise=v},getCanvas(v){getCanvas=v}},0);var requestAnimationFrame,cancelAnimationFrame;module.link('@luma.gl/webgl',{requestAnimationFrame(v){requestAnimationFrame=v},cancelAnimationFrame(v){cancelAnimationFrame=v}},1);var log,assert;module.link('../utils',{log(v){log=v},assert(v){assert=v}},2);/* global window, Worker */
