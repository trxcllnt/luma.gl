"use strict";module.export({Shader:()=>Shader,VertexShader:()=>VertexShader,FragmentShader:()=>FragmentShader});var GL;module.link('@luma.gl/constants',{default(v){GL=v}},0);var parseGLSLCompilerError,getShaderName;module.link('../glsl-utils',{parseGLSLCompilerError(v){parseGLSLCompilerError=v},getShaderName(v){getShaderName=v}},1);var assertWebGLContext;module.link('../webgl-utils',{assertWebGLContext(v){assertWebGLContext=v}},2);var uid,log,assert;module.link('../utils',{uid(v){uid=v},log(v){log=v},assert(v){assert=v}},3);var Resource;module.link('./resource',{default(v){Resource=v}},4);
