"use strict";module.export({getDebugTableForUniforms:()=>getDebugTableForUniforms});var formatValue,assert;module.link('../utils',{formatValue(v){formatValue=v},assert(v){assert=v}},0);
