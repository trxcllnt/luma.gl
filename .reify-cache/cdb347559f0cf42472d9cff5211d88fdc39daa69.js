"use strict";module.export({get:()=>get,getWheel:()=>getWheel,getKey:()=>getKey,isRightClick:()=>isRightClick,getPos:()=>getPos,stop:()=>stop,EventsProxy:()=>EventsProxy,addEvents:()=>addEvents,removeEvents:()=>removeEvents});module.export({Keys:()=>Keys},true);// event.js
...
function addEvents(domElement, opt = {}) {
...
function removeEvents(domElement, opt = {}) {
  opt = Object.assign({}, DEFAULT_OPTS, opt);
