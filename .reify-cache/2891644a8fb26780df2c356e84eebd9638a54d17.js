"use strict";var module1=module;module1.export({makeDebugContext:()=>makeDebugContext,enableDebug:()=>enableDebug,getRealContext:()=>getRealContext,getDebugContext:()=>getDebugContext});var log;module1.link('@luma.gl/core',{log(v){log=v}},0);// Depends on Khronos Debug support module being imported via "luma.gl/debug"
